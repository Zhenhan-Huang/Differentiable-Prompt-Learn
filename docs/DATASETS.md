...
### Acknowledgement: This readme file for installing datasets has been borrowed directly from [CoOp](https://github.com/KaiyangZhou/CoOp/blob/main/DATASETS.md)'s official repository.
